...
## Output
- Write the plan to `REVIEW_FINDINGS_PLAN.md`.
- If `REVIEW_FINDINGS_PLAN.md` already exists, use a non-overwriting name.
- Include agreed decisions, affected files, implementation steps, and tests.
- Make sure the plan is detailed enough so a medium skilled developer/engineer without any context of the repository/code will implement it with consistency and quality and without further questions.
