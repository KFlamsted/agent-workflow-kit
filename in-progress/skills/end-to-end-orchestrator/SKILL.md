...
1. Create an implementation plan for the task.
2. Implement and review the code in a implementer to reviewer loop.
3. Test the code "manually" without knowledge of the code.
4. Conduct a final summary of the entire process.

Each step is described in the referenced subsections.
...
TODO: Describe how the implementation plan section works
